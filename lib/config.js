...
export const EQUIPEMENTS_ICONS = {
  ...
  cuisine_equipee:   { icon: 'ChefHat',     label: 'Cuisine équipée' },
  piscine:           { icon: 'Waves',       label: 'Piscine' },
  television:        { icon: 'Tv',          label: 'Télévision' },
  machine_a_laver:   { icon: 'Shirt',       label: 'Lave-linge' },
  balcon:            { icon: 'Building',    label: 'Balcon' },
  gardien:           { icon: 'ShieldCheck', label: 'Gardien' },
  groupe_electrogene:{ icon: 'Zap',         label: 'Groupe élec.' },
}
