    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: 'var(--muted)', display:'flex', alignItems:'center', gap:4 }}>{r.zone} · <span className="material-icons" style={{fontSize:12,color:'var(--gold)'}}>check_circle</span><span>Client vérifié</span></div>
        </div>
      </div>
    </div>
  )
    ...
    <>
      ...
      <div style={{ padding: 'clamp(56px,9vw,100px) var(--pad)' }}>
        <div style={{
          ...
          <div style={{ position: 'absolute', top: -40, right: 60, width: 260, height: 260, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,122,26,.1) 0%, transparent 70%)', pointerEvents: 'none' }}/>
